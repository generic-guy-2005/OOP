...
public class Withdraw extends javax.swing.JFrame {
    ...
    public Withdraw(Menu main){
        this.main = main;
        initComponents();
    }
    
    public void setWithdrawUser(User currentWithdraw){
    ...
    private void buttonDoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDoneActionPerformed
        double balance = currentWithdraw.getBalance();
        double amount = Double.parseDouble(textAmount.getText());
        
        if(amount < balance){
            if(amount >= 50000){
                int value;
                value = JOptionPane.showConfirmDialog(this, "Confirm withdrawal?\nWithdraw: Rp"+amount, "Confirmation", JOptionPane.YES_NO_OPTION);
                
                if(value == 0){
                    balance = balance - amount;
                    currentWithdraw.setBalance(balance);
                    JOptionPane.showMessageDialog(this, "Withdrawal Success\nBalance: " + balance, "Success", JOptionPane.INFORMATION_MESSAGE);
                    this.dispose();
                }
                else{
                    this.dispose();
                ...
                JOptionPane.showMessageDialog(this, "Minimum allowed withdrawal is Rp50.000", "Status", JOptionPane.WARNING_MESSAGE);
            }
        }
        else{
            JOptionPane.showMessageDialog(this, "Insufficient balance", "Status", JOptionPane.WARNING_MESSAGE);
        }
